...
export default function AegisCareHomepage() {
  ...
  return (
    <div className='h-screen w-screen bg-slate-50 text-slate-800 flex flex-col justify-between overflow-hidden relative selection:bg-indigo-100 selection:text-indigo-900'>
      ...
      {/* FOOTER */}
      <footer className='w-full max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between border-t border-slate-200/50 text-[10px] text-slate-400 z-10 relative shrink-0 gap-2'>
        <span>
