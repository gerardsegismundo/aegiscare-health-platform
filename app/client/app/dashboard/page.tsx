    ...
    <main className="min-h-screen bg-slate-100 p-6">
      <div className="mx-auto max-w-5xl rounded-2xl bg-white p-8 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.2em] text-emerald-700">Patient Dashboard</p>
            <h1 className="mt-2 text-3xl font-bold">Welcome back, Ava</h1>
          </div>
          <div className="rounded-lg bg-slate-900 px-4 py-2 text-sm font-semibold text-white">Patient Role</div>
        </div>
